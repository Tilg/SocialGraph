...
public class Link {
	...
	/**
	 * Label describes the nature of the current link
	 * e.g. : "friend","employe_of"
	 */
	 ...
	 * e.g.: "since=1999", "share=[books,movies,tweets]"
	 */
	protected ArrayList<Property> properties; 
	
	/**
	 * Direction of a link
	 * if the graph is oriented: NONE
	 * If the destination node is the start of the link: OUT
	 * If the destination node is the end of the link: IN
	 */
	protected Direction direction;
	
	/**
	 * Constructor of a none oriented link.
	 * Only the Label and the destination are needed.
	 * 
	 * @param label
	 * @param destination
	 */
	...
	/**
	 * Constructor of a an oriented link.
	 * The Label,the destination and the direction (enum) are needed.
	 * 
	 * @param label
	 * @param destination
	 */
